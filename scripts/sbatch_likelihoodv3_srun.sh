...
#dfmdock_tr - NN
# bash scripts/sbatch_likelihoodv3_template_srun_dfmdock_gpu.sh likelihood_dfmdock_tr_3integrand_flow_40.yaml               '++overwrite_output=True' &
...
# bash scripts/sbatch_likelihoodv3_template_srun_dfmdock_gpu.sh likelihood_dfmdock_tr_2SIC_3integrand_flow_40.yaml              '++overwrite_output=True' &
