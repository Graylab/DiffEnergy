...
from figures.figure3 import plot_correlation, plot_sample_result
...
if __name__ == "__main__":
    ...
    add_comb_row(subfs[0],likelihood_dir,Path('gaussian_1d_diff_smin30_smax70'),'integrand:TotalIntegrand','prior:smax_gaussian','Diffusion Trajectory','(a)',binline=True)
    add_comb_row(subfs[1],likelihood_dir,Path('gaussian_1d_flow_smin30_smax70'),'integrand:TotalIntegrand','prior:smax_gaussian','Flow Trajectory','(b)',binline=True)

    f.savefig("figures/figure_3_smin30.png",dpi=600)